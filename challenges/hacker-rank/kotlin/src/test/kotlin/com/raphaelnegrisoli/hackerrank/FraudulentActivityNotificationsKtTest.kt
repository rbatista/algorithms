...
class FraudulentActivityNotificationsKtTest {
    ...
    fun `test count more than one for first median element`() {
        ...
        assertEquals(0, fraudulentActivity(listOf(1, 2, 1, 3, 4, 5, 5, 8, 2, 1, 4), 10))
        assertEquals(1, fraudulentActivity(listOf(1, 2, 1, 3, 4, 5, 5, 8, 2, 1, 5), 10))
    }
    ...
    fun `test equal first and second median element `() {
        ...
        assertEquals(0, fraudulentActivity(listOf(1, 2, 1, 3, 3, 2, 5, 8, 2, 1, 3), 10))
        assertEquals(1, fraudulentActivity(listOf(1, 2, 1, 3, 3, 2, 5, 8, 2, 1, 4), 10))
    }
